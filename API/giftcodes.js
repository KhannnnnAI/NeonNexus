...
var GiftCodeAPI = (() => {
  ...
  var EXCHANGE_RATE_JPY = 166; // 1 JPY = 166 VND
  var EXCHANGE_RATE_EUR = 27000; // 1 EUR = 27,000 VND
  var EXCHANGE_RATE_HKD = 3300; // 1 HKD = 3,300 VND
  var EXCHANGE_RATE_CNY = 3800; // 1 CNY = 3,800 VND


  // Gift code denominations
  var USD_DENOMINATIONS = [10, 20, 30, 50, 70, 100, 200, 500, 1000];
  var VND_DENOMINATIONS = [10000, 20000, 30000, 50000, 70000, 100000, 200000, 500000, 1000000];
  var JPY_DENOMINATIONS = [1000, 2000, 3000, 5000, 7000, 10000,];
  var EUR_DENOMINATIONS = [10, 20, 30, 50, 70, 100];
  var HKD_DENOMINATIONS = [10, 20, 30, 50, 70, 100];
  var CNY_DENOMINATIONS = [10, 20, 30, 50, 70, 100];
  /**
  ...
  function generateGiftCodes() {
    ...
    var steamImage = 'Image/steam-gift-card.jpg';

    // Generate USD codes
    USD_DENOMINATIONS.forEach((amount, index) => {
      var vndPrice = amount * EXCHANGE_RATE;
    ...
    JPY_DENOMINATIONS.forEach((amount, index) => {
      var vndPrice = amount * EXCHANGE_RATE_JPY;
    ...
    EUR_DENOMINATIONS.forEach((amount, index) => {
      var vndPrice = amount * EXCHANGE_RATE_EUR;
    ...
    HKD_DENOMINATIONS.forEach((amount, index) => {
      var vndPrice = amount * EXCHANGE_RATE_HKD;
    ...
    // Generate CNY codes
    CNY_DENOMINATIONS.forEach((amount, index) => {
      var vndPrice = amount * EXCHANGE_RATE_CNY;
      
      giftCodes.push({
        id: `gift_cny_${amount}`,
        dealID: `gift_cny_${amount}`, // Set dealID match id for hydration
        title: `Steam Wallet Code - ¥${amount} CNY`,
        ...
        rating: '5.0',
        image: steamImage,
        imageFallback: `https://placehold.co/616x353/171a21/ffffff?text=STEAM+¥${amount}+CNY`,
        imageFallback2: `https://placehold.co/616x353/171a21/ffffff?text=STEAM+¥${amount}+CNY`,
        needsRAWG: false,
        platform: 'WALLET CODE',
        specs: 'DIGITAL CODE',
        steamAppID: 'N/A',
